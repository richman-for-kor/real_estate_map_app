...
// ── 앱 전역 색상 팔레트 ──────────────────────────────────────────────────────────
// [UX/UI 디자이너] "Navy Blue & White" — 부동산 서비스의 신뢰감·전문성을 시각적으로 전달.
// 짙은 네이비는 권위와 안정감을, 화이트/오프화이트는 공간감과 명료함을 표현합니다.
const Color kPrimary = Color(0xFF0A2342); // Deep Navy Blue  — 주요 브랜드 컬러
const Color kPrimaryLight = Color(
  0xFF1E3D6E,
); // Medium Navy      — Hover / Container
const Color kSecondary = Color(0xFF4A8FE7); // Sky Blue         — 링크·액션 강조
const Color kSurface = Color(0xFFFFFFFF); // Pure White       — 카드·다이얼로그
const Color kBackground = Color(0xFFF0F4F8); // Cloud White      — 배경·필드 Fill
const Color kBorderColor = Color(0xFFDDE3EA); // Slate Border     — 테두리·구분선
const Color kTextDark = Color(0xFF0D1B2A); // Near Black       — 본문 텍스트
const Color kTextMuted = Color(0xFF6B7280); // Slate Gray       — 힌트·레이블
...
class MyApp extends StatelessWidget {
  ...
  /// 전역 ThemeData 빌드.
  ///
  /// [UX/UI 디자이너] 컴포넌트별 테마를 중앙에서 정의하여 일관된 디자인 언어를 보장합니다.
  ...
  ThemeData _buildTheme() {
    ...
    return ThemeData(
      ...
      // ── AppBar ────────────────────────────────────────────────────────────────
      // [UX] 짙은 네이비 AppBar로 화면 최상단에 강한 브랜드 존재감을 표현합니다.
      ...
      // ── ElevatedButton ────────────────────────────────────────────────────────
      // [UX] Primary CTA(Call-To-Action) 버튼. 그림자 없는 플랫 디자인으로 모던함 강조.
      ...
      // ── OutlinedButton ────────────────────────────────────────────────────────
      // [UX] Secondary CTA. 테두리와 여백으로 ElevatedButton과 명확한 시각적 계층 구분.
      ...
      // [UX] 포커스 시 kPrimary(Navy) 테두리로 입력 상태를 명확히 전달합니다.
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: const TextStyle(fontSize: 14, color: Color(0xFFB0BAC7)),
